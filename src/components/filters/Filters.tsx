...
const Filters = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row justify-between items-center'>
      <div className='w-full flex flex-col md:flex-row items-start md:items-center max-md:gap-4 justify-between'>
        <div className='w-full flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3'>
      ...
      <div className='max-lg:flex justify-end max-lg:w-full max-lg:mb-4'>
        <Button
          className='whitespace-nowrap ml-5 max-md:h-[36px] max-md:text-[11px]'
